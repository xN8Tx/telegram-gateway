...
export interface ApiTelegramUserTelegramUser
  ...
  attributes: {
    ...
    tokens: Schema.Attribute.Relation<'manyToMany', 'api::token.token'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    userId: Schema.Attribute.String &
...
export interface ApiTemplateTemplate extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    fields: Schema.Attribute.Component<'shared.field', true> &
      Schema.Attribute.Required &
...
export interface ApiTokenToken extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::token.token'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    telegram_users: Schema.Attribute.Relation<
      'manyToMany',
      'api::telegram-user.telegram-user'
    >;
